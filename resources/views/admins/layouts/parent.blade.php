               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.createAboutUs') }}" class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.editAboutUs') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>تعديل</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.projects.all') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>جميع المشاريع</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.contacts.edit') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>تعديل جهات الاتصال</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                @isset($service)
                                    <li class="nav-item">
                                        <a href="{{ route('admin.service.edit', $service->id) }}" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>تعديل </p>
                                        </a>
                                    </li>
